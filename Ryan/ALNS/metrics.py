...
def evaluate_alns(optimal_solutions):
    """Evaluate ALNS across all instances"""
    print("Evaluating ALNS Algorithm")
...
def main():
    ...
    # Run evaluation
    results, best_routes = evaluate_alns(optimal_solutions)
    ...
    print(f"\nResults saved:")
    print(f"  Detailed results: ALNS_detailed.csv")
    print(f"  Metrics: ALNS_metrics.csv")
    print(f"  Best routes: ALNS_best.json")
